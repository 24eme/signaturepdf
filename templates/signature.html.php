...
<div id="page-upload">
    ...
    <div class="px-4 py-4 text-center">
        ...
        <p class="fs-5 fw-light mb-3 subtitle text-dark text-nowrap" style="overflow: hidden; text-overflow: ellipsis;"><?php echo _("Sign, initial, stamp, complete a document") ?></p>
