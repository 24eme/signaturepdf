  ...
  <body>
    ...
    <div id="page-organization" class="d-none decalage-pdf-div">
        ...
        <div class="offcanvas offcanvas-end show d-none d-md-block shadow-sm" data-bs-backdrop="false" data-bs-scroll="true" data-bs-keyboard="false" tabindex="-1" id="sidebarTools" aria-labelledby="sidebarToolsLabel">
            <a id="btn_exit" class="btn btn-close btn-sm position-absolute d-none d-sm-none d-md-block" style="right: 16px; top: 16px;" title="<?php echo _("Close this PDF and return to home"); ?>" href="<?php echo $REVERSE_PROXY_URL; ?>/organization"></a>
                        ...
                        <div id="btn_container" class="d-grid gap-2 mt-2">
                            ...
                            <div class="d-flex gap-2 mt-2">
                                <?php if(isset($davFileManager)): ?>
                                    ...
                                    <button type="submit" id="save_to_remote_select" class="btn btn-outline-primary d-none" data-loading-text="<?php echo _("Saving") ?>"><i class="bi bi-cloud-upload"></i> <?php echo _("Save the selection"); ?></button>
                                <?php endif; ?>
