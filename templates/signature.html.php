            ...
            <div class="d-grid gap-2 mb-2 list-item-add">
              ...
              <div class="d-grid gap-2 mb-2 list-item-add">
                  <div class="input-group">
                    <span class="input-group-text btn btn-outline-secondary" id="watermark-addon">
                    ...
                    <input form="form_pdf" type="text" class="form-control" name="watermark" placeholder="Watermark" aria-label="Watermark" aria-describedby="watermark-addon">
                  </div>
              </div>
