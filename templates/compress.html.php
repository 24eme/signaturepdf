...
<head>
    ...
    <meta name="description" content="<?php echo ("Free online software that allows you to compress and reduce the size of a PDF.") ?>">
    ...
    <title><?php echo _("Compress PDF online"); ?></title>
</head>
<body>
<noscript>
