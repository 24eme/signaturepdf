...
<head>
    ...
    <meta name="description" content="<?php echo _("Free open source online software that allows you to add, modify or delete metadata from a PDF.") ?>">
    ...
    <title><?php echo _("Editing PDF metadata online"); ?></title>
</head>
<body>
<noscript>
